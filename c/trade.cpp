...
// SPBM期货合约参数查询
DLL_EXPORT int tReqQrySPBMFutureParameter(CThostFtdcTraderApi *api, CThostFtdcQrySPBMFutureParameterField *pQrySPBMFutureParameter, int nRequestID){
    cout << "ReqQrySPBMFutureParameter" << endl;
    return api->ReqQrySPBMFutureParameter(pQrySPBMFutureParameter, nRequestID);
}
// SPBM期权合约参数查询
DLL_EXPORT int tReqQrySPBMOptionParameter(CThostFtdcTraderApi *api, CThostFtdcQrySPBMOptionParameterField *pQrySPBMOptionParameter, int nRequestID){
    cout << "ReqQrySPBMOptionParameter" << endl;
    return api->ReqQrySPBMOptionParameter(pQrySPBMOptionParameter, nRequestID);
}
// SPBM品种内对锁仓折扣参数查询
DLL_EXPORT int tReqQrySPBMIntraParameter(CThostFtdcTraderApi *api, CThostFtdcQrySPBMIntraParameterField *pQrySPBMIntraParameter, int nRequestID){
    cout << "ReqQrySPBMIntraParameter" << endl;
    return api->ReqQrySPBMIntraParameter(pQrySPBMIntraParameter, nRequestID);
}
// SPBM跨品种抵扣参数查询
DLL_EXPORT int tReqQrySPBMInterParameter(CThostFtdcTraderApi *api, CThostFtdcQrySPBMInterParameterField *pQrySPBMInterParameter, int nRequestID){
    cout << "ReqQrySPBMInterParameter" << endl;
    return api->ReqQrySPBMInterParameter(pQrySPBMInterParameter, nRequestID);
}
// SPBM组合保证金套餐查询
DLL_EXPORT int tReqQrySPBMPortfDefinition(CThostFtdcTraderApi *api, CThostFtdcQrySPBMPortfDefinitionField *pQrySPBMPortfDefinition, int nRequestID){
    cout << "ReqQrySPBMPortfDefinition" << endl;
    return api->ReqQrySPBMPortfDefinition(pQrySPBMPortfDefinition, nRequestID);
}
// 投资者SPBM套餐选择查询
DLL_EXPORT int tReqQrySPBMInvestorPortfDef(CThostFtdcTraderApi *api, CThostFtdcQrySPBMInvestorPortfDefField *pQrySPBMInvestorPortfDef, int nRequestID){
    cout << "ReqQrySPBMInvestorPortfDef" << endl;
    return api->ReqQrySPBMInvestorPortfDef(pQrySPBMInvestorPortfDef, nRequestID);
}
// 投资者新型组合保证金系数查询
DLL_EXPORT int tReqQryInvestorPortfMarginRatio(CThostFtdcTraderApi *api, CThostFtdcQryInvestorPortfMarginRatioField *pQryInvestorPortfMarginRatio, int nRequestID){
    cout << "ReqQryInvestorPortfMarginRatio" << endl;
    return api->ReqQryInvestorPortfMarginRatio(pQryInvestorPortfMarginRatio, nRequestID);
}
// 投资者产品SPBM明细查询
DLL_EXPORT int tReqQryInvestorProdSPBMDetail(CThostFtdcTraderApi *api, CThostFtdcQryInvestorProdSPBMDetailField *pQryInvestorProdSPBMDetail, int nRequestID){
...
// SPBM期货合约参数查询响应
DLL_EXPORT void tSetOnRspQrySPBMFutureParameter(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMFutureParameter = onFunc;
}
// SPBM期权合约参数查询响应
DLL_EXPORT void tSetOnRspQrySPBMOptionParameter(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMOptionParameter = onFunc;
}
// SPBM品种内对锁仓折扣参数查询响应
DLL_EXPORT void tSetOnRspQrySPBMIntraParameter(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMIntraParameter = onFunc;
}
// SPBM跨品种抵扣参数查询响应
DLL_EXPORT void tSetOnRspQrySPBMInterParameter(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMInterParameter = onFunc;
}
// SPBM组合保证金套餐查询响应
DLL_EXPORT void tSetOnRspQrySPBMPortfDefinition(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMPortfDefinition = onFunc;
}
// 投资者SPBM套餐选择查询响应
DLL_EXPORT void tSetOnRspQrySPBMInvestorPortfDef(Trade *spi, void *onFunc){
    spi->_OnRspQrySPBMInvestorPortfDef = onFunc;
}
// 投资者新型组合保证金系数查询响应
DLL_EXPORT void tSetOnRspQryInvestorPortfMarginRatio(Trade *spi, void *onFunc){
    spi->_OnRspQryInvestorPortfMarginRatio = onFunc;
}
// 投资者产品SPBM明细查询响应
