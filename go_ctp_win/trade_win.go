...
type Trade struct {
	...
	// 合约状态
	InstrumentStatues map[string]hf_go_ctp.InstrumentStatusType
	// 持仓列表
...
func NewTrade() *Trade {
	...
	t.InstrumentStatues = make(map[string]hf_go_ctp.InstrumentStatusType)
...
func (t *Trade) ReqConnect(addr string) {
	...
	t.t.SubscribePrivateTopic(go_ctp.THOST_TERT_RESTART)
	t.t.SubscribePublicTopic(go_ctp.THOST_TERT_RESTART)
	t.t.Init()
}
...
// 合约状态响应
func (t *Trade) onStatus(statusField *go_ctp.CThostFtdcInstrumentStatusField) uintptr {
	t.InstrumentStatues[hf_go_ctp.Bytes2String(statusField.InstrumentID[:])] = hf_go_ctp.InstrumentStatusType(statusField.InstrumentStatus)
	return 0
}

// 成交响应
func (t *Trade) onTrade(tradeField *go_ctp.CThostFtdcTradeField) uintptr {
...
// 委托响应
func (t *Trade) onOrder(orderField *go_ctp.CThostFtdcOrderField) uintptr {
...
// 委托错误响应
func (t *Trade) onErrOrder(orderField *go_ctp.CThostFtdcInputOrderField, infoField *go_ctp.CThostFtdcRspInfoField) uintptr {
...
// 撤单错误
func (t *Trade) onErrRtnOrderAction(field *go_ctp.CThostFtdcOrderActionField, infoField *go_ctp.CThostFtdcRspInfoField) uintptr {
	if t.onErrAction != nil {
		t.onErrAction(fmt.Sprintf("%d_%s", field.SessionID, field.OrderRef), &hf_go_ctp.RspInfoField{
...
// 持仓查询响应
func (t *Trade) onPosition(positionField *go_ctp.CThostFtdcInvestorPositionField, infoField *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
...
// 账户资金响应
func (t *Trade) onAccount(accountField *go_ctp.CThostFtdcTradingAccountField, infoField *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
...
// 合约查询响应
func (t *Trade) onInstrument(instrumentField *go_ctp.CThostFtdcInstrumentField, infoField *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
...
// 确认结算相应
func (t *Trade) onSettlement(confirmField *go_ctp.CThostFtdcSettlementInfoConfirmField, infoField *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
	t.t.ReqQryInstrument(go_ctp.CThostFtdcQryInstrumentField{})
	return 0
}

// 登陆响应
func (t *Trade) onLogin(loginField *go_ctp.CThostFtdcRspUserLoginField, infoField *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
...
// 看穿式验证响应
func (t *Trade) onAuth(auth *go_ctp.CThostFtdcRspAuthenticateField, info *go_ctp.CThostFtdcRspInfoField, i int, b bool) uintptr {
	if info.ErrorID == 0 {
		...
		t.onRspUserLogin(&hf_go_ctp.RspUserLoginField{}, &hf_go_ctp.RspInfoField{ErrorID: int(info.ErrorID), ErrorMsg: hf_go_ctp.Bytes2String(info.ErrorMsg[:])})
	}
	return 0
}
