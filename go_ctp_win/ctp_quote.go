...
type qOnRspUserLoginType func(*CThostFtdcRspUserLoginField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspUserLogoutType func(*CThostFtdcUserLogoutField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspErrorType func(*CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspSubMarketDataType func(*CThostFtdcSpecificInstrumentField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspUnSubMarketDataType func(*CThostFtdcSpecificInstrumentField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspSubForQuoteRspType func(*CThostFtdcSpecificInstrumentField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRspUnSubForQuoteRspType func(*CThostFtdcSpecificInstrumentField, *CThostFtdcRspInfoField, int, bool) uintptr
type qOnRtnDepthMarketDataType func(*CThostFtdcDepthMarketDataField) uintptr
type qOnRtnForQuoteRspType func(*CThostFtdcForQuoteRspField) uintptr
