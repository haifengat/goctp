...
// ******** 调用函数 *********
[[ range .Fn]]// [[ .Comment ]]
DLL_EXPORT [[ .RtnType ]] t[[ .Name ]](CThostFtdcTraderApi *api[[ range .Params ]], [[ .Type ]] [[ if .HasStar ]]*[[ end ]][[ .Var ]][[ if eq .Var "ppInstrumentID" ]][][[ end ]][[ end ]]){
    cout << "[[ .Name ]]" << endl;
...
[[ range .On ]]// [[ .Comment ]]
DLL_EXPORT void tSet[[ .Name ]](Trade *spi, void *onFunc){
    spi->_[[ .Name ]] = onFunc;
}
[[ end ]]